...
Route::get('View_file/{invoice_number}/{file_name}', 'IncoicesDetailsController@open_file');

Route::post('delete_file', 'IncoicesDetailsController@destroy')->name('delete_file');
